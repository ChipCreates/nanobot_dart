...
/// Bundle of built-in skills content.
///
/// This file is auto-generated or manually maintained to bundle
/// the markdown and script files for built-in skills.
class BuiltinSkillsBundle {
...
''',
    ...
    'tmux/scripts/find-sessions.sh': r'''#!/usr/bin/env bash
set -euo pipefail
...
''',
    ...
    'tmux/scripts/wait-for-text.sh': r'''#!/usr/bin/env bash
set -euo pipefail
